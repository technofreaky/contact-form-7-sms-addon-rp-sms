...
class contact_form_7_sms_addon_rp_sms_history_listing_table extends WP_List_Table {
...
function cf7si_history_listing(){
    $testListTable = new contact_form_7_sms_addon_rp_sms_history_listing_table();
