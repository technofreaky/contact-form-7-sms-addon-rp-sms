...
class contact_form_7_sms_addon_rp_sms_Plugin_Integration extends contact_form_7_sms_addon_rp_sms_Admin {
	...
	public function add_panel($form) { 
		if ( wpcf7_admin_has_edit_cap() ) {
		  ...
		  $options['form'] = $form;
          $data =  $options; 
		  include(contact_form_7_sms_addon_rp_sms()->get_vars('PATH').'template/cf7-template.php'); 
		}
	}
